...
<body>
<div id="wrapper">
<p class="indhead"> Lista de Voluntarios</p>
<div class="indtable">
	<table >
		<tr class="indheader">
			<th colspan="2"> NOMBRE DE VOLUNTARIO</th>
			<th class="col2">CORREO</th>
			<th class="col3">TELEFONO</th>
			<th class="col4">EVENTO</th>
			<th class="col5">RESPONSABLE</th>
		</tr>
<?php
...
while($row = mysqli_fetch_array($rs)){
   ...
   $sq = " SELECT * from `event_res` where `email`= '$em'";
	...
	echo'	<tr class="indrows">
			...
			<td class="eventnameind">';echo($row["First_Name"]); echo'</td>
			<td class="col2">';echo($row["emailID"]); echo' </td>
			
			<td class="col3">';echo($row["PhoneNo"]); echo'</td>
			<td class="col4"> ';echo($event); echo' </td>
			<td class="col5">';echo($event); echo' </button></td>
		</tr>';
}
?>
	</table>	
