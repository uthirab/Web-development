...
<h4>
	<nav class="header">
		...
		<a style="float:right" class ="lo" href=indprofile.php> Individual </a>
		<a style="float:right"  class ="lo" href=homepageind.php> Inicio </a>
	</nav>
</h4>
</div>
</head>
	...
	<div class="aboutimg">
		<div  style="position: relative; left: 0; top: 0;">
			...
			<div class="centered"><h1> PERFIL </h1></DIV>
				<div class="cent">
					<a class="centered1" href=homepageind.htphpml> HOME </a>
					<a class="centered2" href=indprofile.php> PERFIL </a>
				</div>
		</div>
	</div>
<?php
...
$sqll = "SELECT * from `registration_ind` where `emailID`='uthira16@gmail.com' AND `admin`='ind'";
	...
	<div class="perfilindtable">
		<div class="rowtableind" >
			...
			<br>
				...
				<div class="tcolind">
					<img src="http://uthirabaskaran.uta.cloud/Assignment_2/Baskaran_leanevent/imagenes/imagenes/user.png" width=150px height=150px>
				</div>
			</div>
		</div>';
}
				...
				<form class="indprofileform" style="background-color:#f4f4f4;"  onsubmit='return regind()' method="GET" action="<?=$_SERVER['PHP_SELF'];?>">
					...
					<hr>
						<div class="indtablerow" >
							...
							<div class="scolpro">
								<img src="http://uthirabaskaran.uta.cloud/Assignment_2/Baskaran_leanevent/imagenes/imagenes/user.png" width=125px height=125px><br><button class="btn-group1pro">Seleccionar Foto</button>
							</div>
						</div>
