...
$sql="INSERT INTO `registration_ind`(`admin`, `First_Name`, `Last_Name`, `emailID`, `Password`, `Address`, `City`, `State`, `Zipcode`, `Username`, `PhoneNo`, `Agent_Reg_NO`, `Businesstype`, `Businessname`, `Photo`) VALUES('$who','$fname','$lname','$email','$pass','$address','$city','$state','$zip',' ',' ',' ',' ',' ',' ')";
